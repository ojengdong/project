...
const Id = (props) => {
  ...
  // |
  // |나쁜 점:
  // |- 불필요한 변수 할당이 있다. id.length를 여러 번 사용하는데, 이를 변수에 할당하여 사용하면 코드의 가독성이 더 좋아질 것이다.
  // |- 정규식이 올바르게 작성되지 않았다. id.length < 4 || id.length > 12 === idreg에서 id.length > 12 === idreg 부분이 잘못되었다. 이를 idreg.test(id)로 수정해야 한다.
